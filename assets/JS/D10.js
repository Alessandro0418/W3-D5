...
const result3 = splitMe("I love Epicode");
console.log(result3);
...
console.log(isThisAnEmail("aledigiannangonio@gmail.com"));
console.log(isThisAnEmail("aledigiannangonio.com"));
...
console.log(howManyDays("2025-02-05"));
...
const searchByTitle = function (str) {
  return movies.filter((movies) => movies.Title === str);
};
...
//   const match = movies.filter((movies) => movies.Title);
//   const unmatch = movies.filter((movies) => !movies.Title);
...
// DOM
// (nota: gli elementi che selezionerai non si trovano realmente nella pagina)
...
const printTd = function () {
  const tdElements = document.getElementById("td");
